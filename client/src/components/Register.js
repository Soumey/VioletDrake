...
export default class Register extends Component
{
    ...
    {     
        ...
        return (
            <form className="addProductContainer" noValidate = {true} >
           
                {this.state.isRegistered ? <Redirect to="/Display"/> : null} 
	        ...
	        <input  
                ...
                <LinkInClass value="Register New User" className="loginBtn" onClick={this.handleSubmit} />
